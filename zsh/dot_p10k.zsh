# Generated by Powerlevel10k configuration wizard on 2020-12-08 at 15:02 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='(𝜆) →'
...
function p10k-on-pre-prompt() { p10k display '1|2/right'=show '2/right/time'=hide }

function p10k-on-post-prompt() {
  [[ $last_prompt_dir == $PWD ]] && p10k display '1'=hide '2/right/time'=show
  last_prompt_dir=$PWD
}
  # Instant prompt mode.
  #
